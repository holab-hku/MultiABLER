...
library(tidyverse)
library(MultiABLER)
sysmet('pip install LipidFinder-2.0.2-py3-none-any.whl')
```
...
both online and as python code, and via a simple R wrapper here. Instruction on installing the python
...
```{r, message=FALSE}
run_lipidfinder(input='demo_data/Lx_pos.csv', output='LipidFinder_lx_results', json_param='demo_data/param.filter.demo.pos.json')
run_lipidfinder(input='demo_data/Lx_neg.csv', output='LipidFinder_lx_results', json_param='demo_data/param.filter.demo.neg.json')
run_lipidfinder(input='demo_data/Mx_pos.csv', output='LipidFinder_mx_results', json_param='demo_data/param.filter.demo.pos.json')
run_lipidfinder(input='demo_data/Mx_neg.csv', output='LipidFinder_mx_results', json_param='demo_data/param.filter.demo.neg.json')
```
...
(Röst et al., 2016), SIRIUS and CSI:FingerID (Rurik et al., 2020).
